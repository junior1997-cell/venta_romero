  ...
  if (e.status == 403) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        window.location.href = `${window.location.host =='localhost' || es_numero(parseFloat(window.location.host)) == true ?`${window.location.origin}/front_jdl/admin`:window.location.origin}/admin`;
      } else {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {        
        window.location.href = `${window.location.host =='localhost' || es_numero(parseFloat(window.location.host)) == true ?`${window.location.origin}/front_jdl/admin/vistas/escritorio.php`:window.location.origin+'/admin/vistas/escritorio.php'}`;
      } else {
        window.location.href = `${window.location.host =='localhost' || es_numero(parseFloat(window.location.host)) == true ?`${window.location.origin}/front_jdl/admin/vistas/escritorio.php`:window.location.origin+'/admin/vistas/escritorio.php'}`;
      }
    });
