...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../public/css/style_new.css">
          ...
          if ($_SESSION['almacen'] == 1) {
            echo '<li id="mAlmacen" class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li id="lUnidad_medida"><a href="unidad_medida.php"><i class="fa fa-circle-o"></i> Unidad Medida</a></li>
              </ul>
            </li>';
          }
          ?>
